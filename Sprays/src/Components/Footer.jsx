...
export const Footer = () => {
    return (
        <div className='bg-black text-white py-15'>
            <div className='max-w-6xl mx-auto w-full flex flex-col gap-10 max-lg:px-5'>
                <div className="flex justify-between w-full max-sm:flex-col">
                    <div className="flex flex-col gap-5">
                        <img src="logo-1.webp" alt="a" className='h-[50px] w-[170px] oject-cover' />
                        <span className="text-sm font-medium max-w-[300px]">
                    ...
                    <div className="flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-2 text-sm">
                            ...
                            <Link className='hover:underline'>Faq's</Link>
                            <Link className='hover:underline'> Privacy Policy</Link>
                            <Link className='hover:underline'>Shipping & Policy</Link>
                ...
                <div className="w-full flex items-center justify-between max-sm:flex-col max-sm:gap-2">
                    <span className='text-sm font-medium'>&copy; 2025, Realestate WorkDo, Powered by Shahid</span>
                    <div class="flex items-center gap-1"><div class="payment-image">

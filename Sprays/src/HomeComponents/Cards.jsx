...
export const Cards = () => {
    return (
        <div className='flex items-center gap-5 py-5 max-w-6xl mx-auto w-full max-lg:px-5 max-lg:flex-col'>
            <div className="relative overflow-hidden rounded-3xl w-1/2 h-[300px] max-lg:w-full">
            ...
            <div className="w-1/2 flex items-center gap-5 max-lg:w-full">

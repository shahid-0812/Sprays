...
export const Newsletter = () => {
    return (
        <div className="flex flex-col max-w-6xl mx-auto w-full items-center gap-5 py-15 max-sm:px-5">
            <Heading
                ...
                show='hidden'
            />
            <div className="flex justify-between items-center rounded-full border p-2 w-1/2 max-sm:w-full">

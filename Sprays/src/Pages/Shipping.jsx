...
'
            ...
            <div className="max-w-6xl mx-auto w-full flex flex-col gap-8 py-15">
                <span>
                    ...
                    <br />
                    Several types of goods are exempt from being returned. Perishable goods such as food, flowers, newspapers or magazines cannot be returned. We also do not accept products that are hazardous materials, or flammable liquids or gases.<br />
                    <br />
                ...
                <div className="flex flex-col gap-5">
                    <h1 className='mitr text-4xl'>Refunds (if applicable)</h1>
                    <span>
                        ...
                        If you’ve done all of this and you still have not received your refund yet, please contact us at themesupport@shopify.<br />com.<br />
                        <br />
                ...
                <div className="flex flex-col gap-5">
                    <h1 className='mitr text-4xl'>Exchanges (if applicable)</h1>
                    <span>
                ...
                <div className="flex flex-col gap-5">
                    <h1 className='mitr text-4xl'>Gifts</h1>
                    <span>
                ...
                <div className="flex flex-col gap-5">
                    <h1 className='mitr text-4xl'>Shipping</h1>
                    <span>
